...
This function should only modify configuration layer settings."
  (setq-default
   ...
   dotspacemacs-excluded-packages '(edebug company-tern)
...
before packages are loaded."
  ...
  ;; default-buffer-file-coding-system变量在emacs23.2之后已被废弃
  ;; 使用buffer-file-coding-system代替
  ...
  (add-hook 'before-save-hook 'delete-trailing-whitespace)
                                        ...
                                        ; 禁止询问Keep current list of tags tables also?
  (setq tags-add-tables t)
  ;(setq lsp-java-workspace-dir "~/workspace")
  ;(setq lsp-java-trace-server t)

  ;; 忽略加载.dir-locals.el时的交互警告: contains values that may not be safe
