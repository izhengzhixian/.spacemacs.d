...
;;;; gnus email
;; email地址
(setq izhengzhixian-email "your_id@qq.com")
;; 发送邮件时显示的名字
(setq izhengzhixian-name "your_name")
;; pop服务器
(setq izhengzhixian-pop-server "pop.qq.com")
;; imap服务器
(setq izhengzhixian-imap-server "imap.qq.com")
;; smtp服务器
(setq izhengzhixian-smtp-server "smtp.qq.com")
...
`(
  (nnimap "qq-mail"
           (nnimap-address izhengzhixian-imap-server)
...
;(setq mail-sources
;`((pop
;:server izhengzhixian-pop-server ;; 在这里设置pop3服务器
;:user izhengzhixian-email ;; 用户名
;:port 995
;:stream ssl
;)))

(setq message-send-mail-function 'smtpmail-send-it
      smtpmail-default-smtp-server izhengzhixian-smtp-server
...
;;;; gnus news
(setq user-full-name "your_name")    ;;你在新闻组显示的名字
...
(setq gnus-posting-styles
      `((".*"
     (name izhengzhixian-name)
     (address izhengzhixian-email)
     (signature "")
     ))
)
